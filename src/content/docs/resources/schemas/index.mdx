...
### Gateway Envelope (Wire)

```json
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://harp-protocol.org/schemas/harp-gateway/envelope.json",
  "title": "HARP Gateway Envelope (Wire)",
  "type": "object",
  "required": [
    "msgType",
    "requestId",
...
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
  "$id": "https://harp-protocol.org/schemas/harp-gateway/exchange-status.json",
  "title": "Exchange Status Body",
  "type": "object",
  "required": [
    "requestId",
    "state",
