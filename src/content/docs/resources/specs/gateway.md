---
title: "HARP-GATEWAY Specification"
description: "Gateway semantics: store-and-forward, correlated routing, and delivery for HARP exchanges."
---

Version: 0.2 Draft (Standards-Grade)
Status: Draft Specification (Gateway Semantics)
...
This specification defines **abstract gateway semantics** (independent of transport). An HTTP binding (REST + SSE + WebSocket) is defined in [HARP-GATEWAY-HTTP](/resources/specs/gateway-http/).
...
Transport conformance is defined in [HARP-GATEWAY-HTTP](/resources/specs/gateway-http/).
